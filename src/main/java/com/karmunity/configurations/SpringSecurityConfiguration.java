...
public class SpringSecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable().cors()
                ...
                .requestMatchers(HttpMethod.GET, "/karmunities/**/members").permitAll()
                .requestMatchers(HttpMethod.POST, "/members/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/karmunities/**").authenticated()
                .requestMatchers(HttpMethod.PUT, "/members/**").authenticated()
                .requestMatchers(HttpMethod.PUT, "/karmunities/**").authenticated()
